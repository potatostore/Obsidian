...
<span style="color:rgb(146, 208, 80)">기존 서버 같은 경우 위 삼요소를 모두 서버에서 처리하였다. 하지만 현재 REST API를 사용하는 서버는 MC / V로 View를 React같은 웹에서 알아서 디자인하도록 설계하고, MC의 통제에 집중하게 되었다.</span>
