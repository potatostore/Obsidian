...
Docker을 Ec2에 띄우게 될 경우, auto-scaling과 load-balance를 통해 트래픽의 상황에 맞춰 수직/수평(주로 수평)적 확장을 진행하게 되는데, 멀티 서버 환경에서 새로운 서버를 탄력적으로 띄우게 될 경우, 서버를 준비하는 과정에서 자동으로 docker container을 띄울 수 있어야 되고, 이 과정에서 k8s를 통해 대응할 수 있도록 하는게 주 목적임.
